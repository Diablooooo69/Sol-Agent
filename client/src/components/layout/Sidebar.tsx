...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navItems = [
    ...
    { path: '/smart-contracts', name: 'Smart Contracts', icon: 'ri-file-code-line', color: 'bg-brutalism-green' },
    { path: '/pump', name: 'Pump.fun', icon: 'ri-rocket-line', color: 'bg-brutalism-purple' },
